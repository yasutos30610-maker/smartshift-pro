...
export default function StaffTab({ data, currentStore, updateData }: StaffTabProps) {
  ...
  const COLS = "grid-cols-[180px_90px_140px_90px_90px_70px_90px_100px_110px_50px]";
    ...
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          {/* ヘッダー */}
          <div className={`hidden md:grid ${COLS} gap-4 px-6 py-3 bg-slate-50 border-b border-slate-200 text-[10px] font-black text-slate-400 uppercase tracking-widest items-center`}>
          ...
          <div className="divide-y divide-slate-100">
            {currentStaff.map((staff) => {
              ...
              return (
                ...
                >
                  <div className={`p-4 md:px-4 md:py-2 grid grid-cols-1 md:${COLS} gap-4 items-center`}>
